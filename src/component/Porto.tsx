...
import porto3 from "../images/porto/porto3.jpeg";
const fotoPorto = [
  {
    src: porto1,
    alt: "Porto",
  ...
  return (
    <Row className="mt-3" style={{ borderBottom: "solid thin grey" }}>
      <Col md={props.view === "left" ? 4 : 8}>
        ...
        <p>
          {" "}
          Con i suoi circa 1000 posti barca, il Porto Marina degli Aregai è uno
          dei più importanti sbocchi sul mare della Riviera di Ponente. Presso
          la Marina si trovano anche diversi edifici tra cui la torre di
          controllo, le sidi di varie associazioni, una zona ricreativa e
          sportiva con piscina, campi da tennis, bowling e squash, bar,
          ristoranti, un centro commerciale, parcheggio e un albergo.
        </p>
